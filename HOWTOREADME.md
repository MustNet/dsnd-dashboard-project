...
1. Install from provided source distribution:
   python -m venv venv_review
   .\venv_review\Scripts\Activate.ps1
   pip install --upgrade pip
   pip install dist/employee_events_pkg-0.1.0.tar.gz

2. Quick sanity check:
   python -c "from employee_events.employee import Employee; print('len:', len(Employee().names()))"
   # Expect: 25

3. Start the dashboard:
   pip install uvicorn python-fasthtml
